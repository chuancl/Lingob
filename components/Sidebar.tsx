...
import { LayoutDashboard, BookOpen, Palette, Settings, Briefcase, MousePointerClick, Languages, Database, AppWindow, Sliders, Zap, ArchiveRestore } from 'lucide-react';
...
export const Sidebar: React.FC<SidebarProps> = ({ currentView, onViewChange, onSettingScroll, activeSettingSection }) => {
  ...
  const settingNav = [
    ...
    { id: 'backup-restore', label: '配置备份', icon: ArchiveRestore },
  ] as const;
